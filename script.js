...
// — resize canvases & init particles —
function resize() {
...
// — animate grid, repel near cursor —
...
// — draw static trail, but only fade gently on interval —
...
// gentle fade every 50ms
setInterval(() => {
  nctx.fillStyle = 'rgba(0,0,0,0.02)';
...
// — overlay + manifesto on title click —
